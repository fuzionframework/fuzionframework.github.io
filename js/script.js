...
$("header ul.side-nav li a[href^='#']").on('click', function(e) {
...
$(".docs-sidebar ul li a[href^='#']").on('click', function(e) {
...
function AnchorJS(a) { "use strict";
    ...
    function b(a) { a.icon = a.hasOwnProperty("icon") ? a.icon : "", a.visible = a.hasOwnProperty("visible") ? a.visible : "hover", a.placement = a.hasOwnProperty("placement") ? a.placement : "right", a["class"] = a.hasOwnProperty("class") ? a["class"] : "", a.truncate = a.hasOwnProperty("truncate") ? Math.floor(a.truncate) : 64 }
    ...
    this.options = a || {}, this.elements = [], b(this.options), this.isTouchDevice = function() {
        return !!("ontouchstart" in window || window.DocumentTouch && document instanceof DocumentTouch) }, this.add = function(a) {
        ...
        return this.elements = this.elements.concat(e), this }, this.remove = function(a) {
        ...
        return this }, this.removeAll = function() { this.remove(this.elements) }, this.urlify = function(a) {
        var c, d = /[& +$,:;=?@"#{}|^~[`%!'\]\.\/\(\)\*\\]/g;
        return this.options.truncate || b(this.options), c = a.trim().replace(/\'/gi, "").replace(d, "-").replace(/-{2,}/g, "-").substring(0, this.options.truncate).replace(/^-+|-+$/gm, "").toLowerCase() }, this.hasAnchorJSLink = function(a) {
        var b = (" " + a.firstChild.className + " ").indexOf(" anchorjs-link ") > -1,
            c = (" " + a.lastChild.className + " ").indexOf(" anchorjs-link ") > -1;
        return b || c } }! function(a, b) { "object" == typeof exports && "object" == typeof module ? module.exports = b() : "function" == typeof define && define.amd ? define(b) : "object" == typeof exports ? exports.Holder = b() : a.Holder = b() }(this, function() {
    return function(a) {
        function b(d) {
        ...
        (function(a) { b.extend = function(a, b) {
                ...
                return !(!b.height || !b.width) && b } }).call(b, function() {
            return this }()) }, function(a) {
        var b = function() {},
...
! function(a) { "use strict";
    ...
    K.config = function(a) {
        if ("object" == typeof a && null !== a && D(N, a), "string" != typeof a || !a) {
            ...
            return b }
        if (N.hasOwnProperty(a)) return N[a] }, K.destroy = function() { K.deactivate();
        for (var a in h)
...
! function(a) { "use strict";
    a(function() {
        var b = a(window),
            c = a(document.body);
        c.scrollspy({ target: ".docs-sidebar" }), b.on("load", function() { c.scrollspy("refresh") }), a('.docs-container [href="#"]').click(function(a) { a.preventDefault() }), setTimeout(function() {
                ...
                b.affix({ offset: { top: function() {
                            ...
                            return this.bottom = a(".docs-footer").outerHeight(!0) } } }) }, 100), setTimeout(function() { a(".bs-top").affix() }, 100),
            function() {
                ...
                localStorage.getItem("previewTheme") && d(), c.click(function() {
                    var a = b.attr("href");
                    a && 0 !== a.indexOf("data") ? (b.attr("href", ""), c.text("Preview theme"), localStorage.removeItem("previewTheme")) : d() }) }(), a(".tooltip-demo").tooltip({ selector: '[data-toggle="tooltip"]', container: "body" }), a(".popover-demo").popover({ selector: '[data-toggle="popover"]', container: "body" }), a(".tooltip-test").tooltip(), a(".popover-test").popover(), a(".docs-popover").popover(), a("#loading-example-btn").on("click", function() {
                var b = a(this);
                b.button("loading"), setTimeout(function() { b.button("reset") }, 3e3) }), a("#exampleModal").on("show.bs.modal", function(b) {
                var c = a(b.relatedTarget),
                    d = c.data("whatever"),
                    e = a(this);
                e.find(".modal-title").text("New message to " + d), e.find(".modal-body input").val(d) }), a(".docs-activate-animated-progressbar").on("click", function() { a(this).siblings(".progress").find(".progress-bar-striped").toggleClass("active") }), ZeroClipboard.config({ moviePath: "/assets/flash/ZeroClipboard.swf", hoverClass: "btn-clipboard-hover" }), a(".highlight").each(function() {
...
function() { "use strict";
    anchors.options.placement = "left", anchors.add(".docs-section > h1, .docs-section > h2, .docs-section > h3, .docs-section > h4, .docs-section > h5") }();
